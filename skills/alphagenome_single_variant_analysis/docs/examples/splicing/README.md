...
-   **Report**: [alphagenome_single_variant_analysis\docs\examples\splicing\alphagenome_single_variant_analysis\docs\examples\splicing\dlg1_report.md](dlg1_report.md)
...
-   **Report**: [alphagenome_single_variant_analysis\docs\examples\splicing\alphagenome_single_variant_analysis\docs\examples\splicing\col6a2_report.md](col6a2_report.md)
