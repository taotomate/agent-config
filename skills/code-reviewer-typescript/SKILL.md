...
description: 'Migrated skill: code-reviewer-typescript'
version: 1.0.0
author: unknown
generator_model: unknown
model_tier: medium
inherited_from: D:\todas-las-skills-llm\skills\code-reviewer-typescript\SKILL.md
...
- Triggers: "code-reviewer-typescript", "use code-reviewer-typescript"
