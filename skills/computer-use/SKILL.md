---
name: computer-use
description: "Drive the user's desktop in the background — clicking, typing, scrolling, dragging — without stealing the cursor, keyboard focus, or switching virtual desktops. Cross-platform: macOS, Windows, Linux."
version: 2.0.0
author: TaoTomate
model_tier: medium
...
- TODO: Add specific triggers for computer-use
- Triggers: "computer-use", "use computer-use"
