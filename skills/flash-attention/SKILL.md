...
**Integration with HuggingFace Transformers**: See [references\transformers-integration.md](references\transformers-integration.md) for enabling Flash Attention in BERT, GPT, Llama models.
