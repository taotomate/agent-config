...
- Triggers: "judgment-day", "use judgment-day"
...
1. Obtain the skill registry: search engram (`mem_search(query: "skill-registry", project: "{project}")`) → fallback to `.config/skill-registry.md` from the project root → skip if none
