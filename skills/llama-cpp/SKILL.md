...
- **[llama-cpp\references\llama-cpp\references\llama-cpp\references\hub-discovery.md](references/hub-discovery.md)** - URL-only Hugging Face workflows, search patterns, GGUF extraction, and command reconstruction
