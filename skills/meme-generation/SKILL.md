...
- Triggers: "meme-generation", "use meme-generation"
...
4. Find the skill's script directory:
   ```
   SKILL_DIR=$(dirname "$(find agent-customization\references\skills.md -path '*/meme-generation/SKILL.md' 2>/dev/null | head -1)")
   ```
5. Run the generator:
   ```bash
